const ThemeToggler = ({ toggler, isDark }) => (
	<div className="flex items-center justify-center mx-auto absolute top-5 right-16">
		<button className="h-10 w-10 flex justify-center items-center focus:outline-none text-yellow-500" onClick={toggler}>
		...
		<div>
			<input type="checkbox" name="theme-switcher" id="checkbox" className="hidden" onChange={toggler} checked={isDark} />
		...
		<button className="h-10 w-10 flex justify-center items-center focus:outline-none text-black-500" onClick={toggler}>
